...
export class LugarProveedorController {
  ...
  async find(
    ...
    return this.lugarRepository.proveedores(id).find(filter);
  }
  ...
  async create(
    ...
    return this.lugarRepository.proveedores(id).create(proveedor);
  }
  ...
  async patch(
    ...
    return this.lugarRepository.proveedores(id).patch(proveedor, where);
  }
  ...
  async delete(
    ...
    return this.lugarRepository.proveedores(id).delete(where);
  }
}
