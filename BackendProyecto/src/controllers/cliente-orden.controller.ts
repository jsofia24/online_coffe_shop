...
export class ClienteOrdenController {
  ...
  async find(
    ...
    return this.clienteRepository.ordenes(id).find(filter);
  }
  ...
  async create(
    ...
    return this.clienteRepository.ordenes(id).create(orden);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.ordenes(id).patch(orden, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.ordenes(id).delete(where);
  }
}
